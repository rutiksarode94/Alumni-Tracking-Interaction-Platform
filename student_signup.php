                ...
                if (response === 'exists') {
                    ...
                    $.ajax({
                        ...
                        success: function(userData) {
                            ...
                            if (user.user_type) {
                                $('input[name="user_type"][value="' + user.user_type + '"]').prop('disabled', true).prop('checked', true);
                            }
                        },
                ...
                console.error(xhr.responseText);
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="user_type" id="alumniRadio" value="alumni" disabled>
