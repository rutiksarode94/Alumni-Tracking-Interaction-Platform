...
// Check if the current date is June 1st at 0:00 AM
$currentDate = date('Y-m-d H:i:s');
$targetDate = date('Y-06-1 00:00:00'); // June 1st at 0:00 AM

// Check if the current date matches the target date
if ($currentDate >= $targetDate && $currentDate < date('Y-06-02 00:00:00')) {
    // Get the current year
    $currentYear = date('Y');

    // Update user_type from 'student' to 'alumni' for records where batch is the current year
    // Update the current_year column to 'Alumni' as well
    $updateQuery = "UPDATE alumnus_bio 
                    SET user_type = 'alumni', current_year = 'Alumni' 
                    WHERE batch = '$currentYear' AND user_type = 'student'";
...
<div class="container-fluid">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             // Sort by primary key in descending order (assuming id is the timestamp or represents the order of insertion)
    ...
    <div class="dropdown">
        ...
        <a class="dropdown-item view_user" href="view_alumni.php?id=<?php echo $row['id'] ?>">View</a>
