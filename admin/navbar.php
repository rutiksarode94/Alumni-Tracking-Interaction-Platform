...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=forums" class="nav-item nav-forums"><span class='icon-field'><i class="fa fa-comments"></i></span> Send messege</a>
				<a href="index.php?page=contactus" class="nav-item nav-contactus"><span class='icon-field'><i class="fa fa-envelope"></i></span> Contact Us</a>
