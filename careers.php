   ...
   <?php
    ...
    <div class="card job-list" data-id="<?php echo $row['id'] ?>">
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <button class="btn btn-danger delete_job" data-id="<?php echo $row['id'] ?>">Delete</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
   ...
   $('#filter').keypress(function(e){
    ...
    $('.delete_job').click(function(){
        _conf("Are you sure to delete this job post?", "delete_job", [$(this).attr('data-id')], 'mid-large');
    });
