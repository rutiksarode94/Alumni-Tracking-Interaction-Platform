			...
			<div class="card-body">
				<form action="" id="manage-event">
					...
					<div class=" row form-group">
						...
						<div class="col-md-5">
							<img src="<?php echo isset($banner) ? 'admin/assets/uploads/'.$banner :'' ?>" alt="" id="banner-field">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-sm btn-block btn-primary">Save</button>
								</div>
								<div class="col-md-6">
									<button class="btn btn-sm btn-block btn-primary" onclick="goBack()">Back</button>
								</div>
							</div>
						</div>
					</div>
